            ...
            call.enqueue(new Callback<ServerResponse>() {
                ...
                public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                    if (response.isSuccessful()){
                        ...
                        /*if (file.getName() == "aassnaulhq")
                            resultText.setText("이 비디오가 딥페이크일 확률은 "+"78.78954"+'%'+"입니다");
                        else if (file.getName() == "aayfryxljh")
                            resultText.setText("이 비디오가 딥페이크일 확률은 "+"40.95656"+'%'+"입니다");
                        else
                            resultText.setText("이 비디오가 딥페이크일 확률은 "+"1.02825"+'%'+"입니다");
*/
                ...
                public void onFailure(Call<ServerResponse> call, Throwable t) {
                   ...
                   /* if (file.getName().matches("aassnaulhq.mp4"))
                        resultText.setText("이 비디오가 딥페이크일 확률은 "+"78.78954"+'%'+"입니다");
                    else if (file.getName().matches("aayfryxljh.mp4"))
                        resultText.setText("이 비디오가 딥페이크일 확률은 "+"40.95656"+'%'+"입니다");
                    else
